...
class SPI_CURRENT_PMU_MEASURE: public testmethod::TestMethod {
protected:
	double mWait_time;
	int mdebug;
protected:
	...
	virtual void run() {
        ...
        ac_relay.pin("SENADDR0,SENADDR1,SENADDR2,SENADDR3,SENADDR4,SENADDR5,SENADDR6,COMMMODE, BLEN, INPUTMODE, MUXEN, OSCON, MUX0OUTA, MUX1OUTA, SPISSN, SPIMOSI, SPISCLK").set("AC","OFF");
...
REGISTER_TESTMETHOD("SPI_CURRENT_PMU_MEASURE", SPI_CURRENT_PMU_MEASURE);
