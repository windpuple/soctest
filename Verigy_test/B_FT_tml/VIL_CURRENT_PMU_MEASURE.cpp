...
class VIL_CURRENT_PMU_MEASURE: public testmethod::TestMethod {
protected:
	double mWait_time;
	int mdebug;
protected:
	...
	virtual void run() {
		...
		printf("MUX0OUTA current ADDRESS VIL : %lf \n",iMUX0OUTA);

		TEST("VIL_CURRENT_MUX0OUTA", "VIL_CURRENT_MUX0OUTA", LIMIT(TM::GT, -4.5 MA ,
...
REGISTER_TESTMETHOD("VIL_CURRENT_PMU_MEASURE", VIL_CURRENT_PMU_MEASURE);
